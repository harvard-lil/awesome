...
class Organization(models.Model):
    ...
    about_page_blurb = models.TextField(max_length=4000, default="The Awesome Box is a collaboration with the Harvard Library Innovation Lab. It allows the community see what others have found helpful, entertaining, or mind-blowing.")
