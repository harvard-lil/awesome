...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShelfItem.date_created'
        db.add_column(u'awesome_shelfitem', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Shelf.date_created'
        db.add_column(u'awesome_shelf', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShelfItem.date_created'
        db.delete_column(u'awesome_shelfitem', 'date_created')

        # Deleting field 'Shelf.date_created'
        db.delete_column(u'awesome_shelf', 'date_created')
    ...
    models = {
        ...
        u'awesome.shelf': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
