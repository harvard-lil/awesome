...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Organization.twitter_consumer_secret'
        db.delete_column(u'awesome_organization', 'twitter_consumer_secret')

        # Deleting field 'Organization.twitter_consumer_key'
        db.delete_column(u'awesome_organization', 'twitter_consumer_key')


    def backwards(self, orm):
        # Adding field 'Organization.twitter_consumer_secret'
        db.add_column(u'awesome_organization', 'twitter_consumer_secret',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.twitter_consumer_key'
        db.add_column(u'awesome_organization', 'twitter_consumer_key',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)
