...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.theme'
        db.add_column(u'awesome_organization', 'theme',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.theme'
        db.delete_column(u'awesome_organization', 'theme')
