    	...
    	if item.cover_art:
    	  ...
    	  if item.isbn:
    	    if item.branch.organization.cover_service == 'openlibrary' or item.branch.organization.cover_service == 'notset':
                ...
                return '<img src="http://www.syndetics.com/index.php?isbn=' + item.isbn + '/mc.gif&client=' + item.branch.organization.cover_user_id + '" />' + item.title + ' by ' + item.creator
    	    ...
    	    return '<img src="http://' + item.branch.organization.slug + '.awesomebox.io/static/images/grey-cover.png" />' + item.title + ' by ' + item.creator
